...
exports.emailService = exports.sendSeatSlotEndingWarningEmail = exports.sendBookingCancelledByAdminEmail = exports.sendSeatNoShowCancellationEmail = exports.sendFinePaidReceiptEmail = exports.sendLoanOverdueAlertEmail = exports.sendLoanDueDateWarningEmail = exports.sendLoanConfirmationEmail = exports.sendBookingConfirmationEmail = void 0;
 ...
 */
const sendHtmlEmail = async (toEmail, subject, htmlContent) => {
...
const sendLoanConfirmationEmail = async (opts) => {
    const { toEmail, studentName, bookTitle, bookAuthor, barcodeOrIsbn, block, shelfNumber, borrowDateStr, dueDateStr, fineRatePerDay = 5, } = opts;
...
exports.sendLoanConfirmationEmail = sendLoanConfirmationEmail;
const sendLoanDueDateWarningEmail = async (opts) => {
    const { toEmail, studentName, bookTitle, dueDateStr, daysRemaining = 2, fineRatePerDay = 5, } = opts;
...
exports.sendLoanDueDateWarningEmail = sendLoanDueDateWarningEmail;
const sendLoanOverdueAlertEmail = async (opts) => {
    const { toEmail, studentName, bookTitle, dueDateStr, daysOverdue, fineAmount, fineRatePerDay = 5, } = opts;
...
exports.sendLoanOverdueAlertEmail = sendLoanOverdueAlertEmail;
const sendFinePaidReceiptEmail = async (opts) => {
    const { toEmail, studentName, bookTitle, fineAmount, paymentMethod, chalanNumber, paidDateStr, } = opts;
...
exports.sendFinePaidReceiptEmail = sendFinePaidReceiptEmail;
const sendSeatNoShowCancellationEmail = async (opts) => {
    const { toEmail, studentName, seatNumber, zoneName, dateStr, slotName, timeRange = "", graceMinutes = 15, } = opts;
    const slotDisplay = slotName.charAt(0).toUpperCase() + slotName.slice(1).toLowerCase();
...
exports.sendSeatNoShowCancellationEmail = sendSeatNoShowCancellationEmail;
const sendBookingCancelledByAdminEmail = async (opts) => {
    const { toEmail, studentName, seatNumber, zoneName, dateStr, slotName, timeRange = "", cancelReason = "Cancelled by Library Administration", } = opts;
    const slotDisplay = slotName.charAt(0).toUpperCase() + slotName.slice(1).toLowerCase();
...
exports.sendBookingCancelledByAdminEmail = sendBookingCancelledByAdminEmail;
const sendSeatSlotEndingWarningEmail = async (opts) => {
    const { toEmail, studentName, seatNumber, zoneName, dateStr, slotName, slotEndTimeStr = "", minutesRemaining = 10, } = opts;
    const slotDisplay = slotName.charAt(0).toUpperCase() + slotName.slice(1).toLowerCase();
...
exports.sendSeatSlotEndingWarningEmail = sendSeatSlotEndingWarningEmail;
exports.emailService = {
    sendBookingConfirmationEmail: exports.sendBookingConfirmationEmail,
    sendLoanConfirmationEmail: exports.sendLoanConfirmationEmail,
    sendLoanDueDateWarningEmail: exports.sendLoanDueDateWarningEmail,
    sendLoanOverdueAlertEmail: exports.sendLoanOverdueAlertEmail,
    sendFinePaidReceiptEmail: exports.sendFinePaidReceiptEmail,
    sendSeatNoShowCancellationEmail: exports.sendSeatNoShowCancellationEmail,
    sendBookingCancelledByAdminEmail: exports.sendBookingCancelledByAdminEmail,
    sendSeatSlotEndingWarningEmail: exports.sendSeatSlotEndingWarningEmail,
};
