...
bookRoute.post("/upload-image", (0, authCheck_1.default)("admin", "librarian"), cloudinary_1.upload.single("image"), book_controller_1.BookController.uploadBookImage);
// Admin / Librarian management endpoints
bookRoute.post("/", (0, authCheck_1.default)("admin", "librarian"), cloudinary_1.upload.single("image"), (0, requestValidator_1.default)(book_validation_1.BookValidation.createBookSchema), book_controller_1.BookController.createBook);
bookRoute.patch("/:id", (0, authCheck_1.default)("admin", "librarian"), cloudinary_1.upload.single("image"), (0, requestValidator_1.default)(book_validation_1.BookValidation.updateBookSchema), book_controller_1.BookController.updateBook);
